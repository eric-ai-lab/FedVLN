...
class Seq2SeqAgent(BaseAgent):
    ...
    def __init__(self, env, results_path, tok, episode_len=20):
        ...
        # Evaluations
        self.losses = []
        self.criterion = nn.CrossEntropyLoss(ignore_index=args.ignoreid, size_average=False).cuda()
    ...
    def rollout(self, train_ml=None, train_rl=True, reset=True, speaker=None, env_dataset=None,
                old_models=None, global_net=None, global_weight=None, env_classifier=None, adv_dataset=None):
        """
        ...
        if train_ml is not None:
            ...
            self.logs['IL_loss'].append((ml_loss / batch_size).item())
